...
public class SubscriptionController {
	...
	@GetMapping("/subscription/{prettryName}/ranking/{userId}")
	public ResponseEntity<?> generateRankingByEventAndUser(@PathVariable String prettryName, 
														   @PathVariable Integer userId){
		try {	
			return ResponseEntity.ok(service.getRankingByUser(prettryName, userId));
